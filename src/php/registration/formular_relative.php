...
if(($_POST['pwd']) != ($_POST['pwd2'])){
	...
	if ($_SERVER["REQUEST_METHOD"] == "POST" && $_POST['pwd'] == $_POST['pwd2']) {
		...
		else
		{
			...
			<p>Please connect yourself to a relative. To do this please enter the E-Mail address of the registred elderly. </p>
			
			
			<form action='formular_relative-conn.php' method='post'>
			Elderly E-Mail: <input type='text' name='emailelderly' size='45' required maxlength='45'>
